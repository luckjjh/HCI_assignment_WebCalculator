...
WebUI.initWidgets = function() {
    ...
    WebUI.app = new WebUI.Container({
        desired_size:{width:950, height:700},
        ...
        children:[
            WebUI.app = new WebUI.Container({//main constructor
                desired_size:{width:900, height:500},
                horizontal_alignment:WebUI.Alignment.CENTER,
                drawConst:true,
                children:[
                    WebUI.app = new WebUI.Row({
                        children:[
                            new WebUI.Container({
                                desired_size: {width:900, height:100},
                                horizontal_alignment: WebUI.Alignment.CENTER,
                                vertical_alignment : WebUI.Alignment.CENTER,
                                drawConst:false,
                                children:[new WebUI.Text("WebUI Calculator")],
                            }),
                            new WebUI.Container({
                                desired_size: {width:900, height:75},
                                horizontal_alignment: WebUI.Alignment.CENTER,
                                drawConst:false,
                                children:[WebUI.calText = new WebUI.TextField(displayValue,{width:700,height:50})],
                            }),
                            new WebUI.Container({
                                desired_size: {width:900,height:500},
                                horizontal_alignment: WebUI.Alignment.CENTER,
