...
// Widget base class
WebUI.Widget = function() {// IMPLEMENT HERE!
...
// Text widget
WebUI.Text = function(label) {// IMPLEMENT HERE!
...
WebUI.Text.prototype.initVisualItems = function() {// IMPLEMENT HERE!
...
WebUI.Image.prototype.initVisualItems = function() {// IMPLEMENT HERE!
    let widget = this;
...
WebUI.PushButton.prototype.handleMouseDown = function() {// IMPLEMENT HERE!
    if(!this.is_pushed){
...
WebUI.PushButton.prototype.handleMouseUp = function() {// IMPLEMENT HERE!
    if(this.is_pushed){
        this.translate({x:0,y:-5});
        this.is_pushed=false;
        return true;
...
WebUI.PushButton.prototype.handleMouseEnter = function() {// IMPLEMENT HERE!
    this.visual_items[0].set('strokeWidth',3);
    return true;
}

WebUI.PushButton.prototype.handleMouseExit = function() {// IMPLEMENT HERE!
...
WebUI.TextField.prototype.initVisualItems = function() {// IMPLEMENT HERE!
...
WebUI.Switch.prototype.handleMouseDown = function() {
    ...
    if(this.is_on==false){
        switch_circle.set('stroke','rgb(48,209,88)');
        switch_boundary.set('stroke','rgb(48,209,88)');
        switch_boundary.set('fill','rgb(48,209,88)');
